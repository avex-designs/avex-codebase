...
class SwiperContainer extends ClassToExtend {
  ...
  static get observedAttributes() {
    const attrs = _components_shared_params_list_js__WEBPACK_IMPORTED_MODULE_1__.paramsList.filter((param) => param.includes('_'))
      .map((param) =>
        param
          .replace(/[A-Z]/g, (v) => `-${v}`)
          .replace('_', '')
...
(() => {
/*!*************************************************!*\
  !*** ./src/scripts/components/swiper-loader.js ***!
  \*************************************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _helpers__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../helpers */ "./src/scripts/helpers.js");
/* harmony import */ var swiper_element__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! swiper/element */ "./node_modules/swiper/element/swiper-element.js");
/**
 * Sample code:
 * 
...
(0,swiper_element__WEBPACK_IMPORTED_MODULE_1__.register)();
  ...
  async getSwiperModule(name) {
    if (!(name in window))
      window.components[name] &&
        (await (0,_helpers__WEBPACK_IMPORTED_MODULE_0__.loadJS)(window.components[name], ($script) =>
